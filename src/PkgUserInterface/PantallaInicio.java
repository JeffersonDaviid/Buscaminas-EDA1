...
int mostrarSelectorDificultad(JFrame frame) {
    ...
    dificultad = JOptionPane.showOptionDialog(frame, "Seleccione la dificultad:", "Selector de Dificultad",
...
private int pedirNombre(JFrame frame) {
    ...
    if (nombre != null && !nombre.isEmpty()) {
        ...
        JOptionPane.showMessageDialog(frame, "Nombre inválido. El juego no se iniciará.");
    }
    return dificultad;
}
    ...
    // Método para iniciar el juego con la dificultad y nombre del jugador
        private int iniciarJuego(String nombre) {
            // Dependiendo de la dificultad seleccionada (guardada en la variable dificultad)
